    ...
    document.getElementById('login-form').addEventListener('submit', function(e) {
      e.preventDefault();
      const park = document.getElementById('admin-park').value;
      ...
      if (!park) {
        document.getElementById('login-alert-text').textContent = 'Please select an Industrial Park.';
      ...
      const parkSelect = document.getElementById('admin-park');
      const parkName = parkSelect.options[parkSelect.selectedIndex].text;
      document.getElementById('selected-park-name').textContent = parkName;
    ...
    document.getElementById('btn-verify').addEventListener('click', function() {
      ...
      setTimeout(() => {
        ...
        window.location.href = 'industrial-admin-dashboard.html';
      }, 1500);
    });
