                                ...
                                <div className="product-gallery">
                                    ...
                                    <div className="main-image-wrapper">
                                        <div className="image-zoom-container">
                                            <img src="/assets/images/product-details-1.webp" alt="Product Image"
                                                className="img-fluid main-image drift-zoom" id="main-product-image"
                                ...
                                <div className="product-info-wrapper" id="product-info-sticky">
                                    ...
                                    <div className="product-meta">
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            <span className="product-category">Hand Tool</span>
                                            <div className="product-share">
                                                <button className="share-btn" aria-label="Share product">
                                                    <i className="bi bi-share"></i>
                                                </button>
                                                <div className="share-dropdown">
                                                    <a href="#" aria-label="Share on Facebook"><i className="bi bi-facebook"></i></a>
                                                    <a href="#" aria-label="Share on Twitter"><i className="bi bi-twitter-x"></i></a>
                                                    <a href="#" aria-label="Share on Pinterest"><i className="bi bi-pinterest"></i></a>
                                                    <a href="#" aria-label="Share via Email"><i className="bi bi-envelope"></i></a>
                                                </div>
                                            </div>
                                        </div>

                                        <h1 className="product-title">Máy khoan cầm tay Makita DA333D</h1>
                                        ...
                                        <div className="product-rating">
                                            ...
                                            <a href="#reviews" className="rating-count">42 Reviews</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="product-price-container">
                                        <div className="price-wrapper align-items-center d-flex">
                                            ...
                                            <a href="#footer" className="btn btn-outline-danger fw-bold py-2 px-3 shadow-sm"
                                                style={{ borderWidth: '2px', borderRadius: '8px' }}>
                                                <i className="bi bi-telephone-inbound-fill me-2"></i>Bấm để nhận báo giá
                                            </a>
                                        ...
                                        <div className="stock-info mt-3 text-success d-flex align-items-center">
                                            ...
                                            <div>
                                                <div className="fw-bold">Kho Bình Dương: Sẵn hàng</div>
                                                <div className="small text-muted">Có thể giao ngay trong ngày</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="product-short-description">
                                        <p>Bạn đang tìm kiếm một máy khoan vặn vít dùng pin đáng tin cậy cho các dự án DIY của mình?
                                            ...
                                            khoan lỗ lớn một cách dễ dàng.</p>
                                    </div>
                                    ...
                                    <div className="product-options">
                                        <div className="product-specs mt-4 mb-4">
                                            ...
                                            <ul className="list-unstyled" style={{ lineHeight: 2 }}>
                                                <li><i className="bi bi-check-circle-fill text-success me-2"></i> <strong>Công suất:</strong> 170W</li>
                                                <li><i className="bi bi-check-circle-fill text-success me-2"></i> <strong>Khả năng khoan thép lên đến:
                                                </strong> 10 mm</li>
                                                <li><i className="bi bi-check-circle-fill text-success me-2"></i> <strong>Trọng lượng:</strong> 0.9 kg
                                                </li>
                                                <li><i className="bi bi-check-circle-fill text-success me-2"></i> <strong>Bảo hành:</strong> 6 tháng
                                                    chính hãng</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="option-group">
                                            ...
                                            <div className="quantity-selector">
                                                ...
                                                <input type="number" className="quantity-input" defaultValue={1} min={1} max={24} />
                                    ...
                                    <div className="buttons d-flex flex-wrap gap-2 mt-4">
                                        ...
                                        <button className="btn btn-primary flex-grow-1 py-3 text-uppercase fw-bold shadow-sm"
                                            onClick={() => alert('Đã thêm sản phẩm vào danh sách yêu cầu báo giá!')}>
                                            <i className="bi bi-cart-plus-fill me-2 fs-5"></i> Thêm vào Giỏ Báo Giá
                                        </button>
                                    ...
                                    <div className="delivery-options">
                                        <div className="delivery-option">
                                            ...
                                            <div>
                                                <h6>Free Shipping</h6>
                                                <p>On orders over 10.000.000VNĐ</p>
                                            </div>
                                        </div>
                                        <div className="delivery-option">
                                ...
                                <div className="product-details-accordion">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header">
                                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#description"
                                        ...
                                        <div id="description" className="accordion-collapse collapse show">
                                            <div className="accordion-body">
                                                <div className="product-description">
                                                    ...
                                                    <p>Bạn đang tìm kiếm một máy khoan vặn vít dùng pin đáng tin cậy cho các dự án DIY của mình? Vậy
                                                        ...
                                                        nhà hay các thợ thủ công chuyên nghiệp.</p>

                                                    <div className="row mt-4">
                                                        <div className="col-md-6">
                                                            <h4>Key Features</h4>
                                                            <ul className="feature-list">
                                                                <li><i className="bi bi-check-circle"></i> Sử dụng để khoan và vặn vít các vật liệu như thép,
                                                                    gỗ, nhựa, vv.
                                                                    elit</li>
                                                                <li><i className="bi bi-check-circle"></i> Phù hợp với các công việc DIY, xây dựng nhà cửa, lắp
                                                                    đặt thiết bị, vv.</li>
                                                                <li><i className="bi bi-check-circle"></i> Pin sạc tiện lợi cho việc sử dụng di động</li>
                                                                <li><i className="bi bi-check-circle"></i> Đèn LED hỗ trợ giúp làm việc dễ dàng trong điều kiện
                                                                    thiếu ánh sáng.
                                                                </li>
                                                                <li><i className="bi bi-check-circle"></i>Thiết kế nhỏ gọn, dễ dàng di chuyển và sử dụng ở những
                                                                    không gian hẹp.
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-md-6">
                                                            ...
                                                            <ul className="feature-list">
                                                                <li><i className="bi bi-box"></i> 01 thân máy DA333D</li>
                                                                <li><i className="bi bi-box"></i> 01 móc treo</li>
                                                                <li><i className="bi bi-box"></i> Sách hướng dẫn sử dụng</li>
                                                                <li><i className="bi bi-box"></i> Sạc nhanh(DC10SB)</li>
                                                                <li><i className="bi bi-box"></i> 2 pin 1.5Ah(BL1016)</li>
                                                                <li><i className="bi bi-box"></i> Mũi vít (+)(+)(784202-3)</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div className="specs-group">
                                                                ...
                                                                <div className="specs-table">
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Mã sản phẩm</div>
                                                                        <div className="specs-value">DA333Dk</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Nhà sản xuất</div>
                                                                        <div className="specs-value">Makita</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Pin</div>
                                                                        <div className="specs-value">12 V</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Loại pin</div>
                                                                        <div className="specs-value">Lithium-ion LXT x 2</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Tốc độ không tải thấp</div>
                                                                        <div className="specs-value">0-450 vòng/phút</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Tốc độ không tải cao</div>
                                                                        <div className="specs-value">0-1700 vòng/phút</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Kích thước</div>
                                                                        <div className="specs-value">189x66x209mm (L x W x H)</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Trọng lượng</div>
                                                                        <div className="specs-value">0.9kg</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Công suất</div>
                                                                        <div className="specs-value">170W</div>
                                                                    </div>
                                                                    <div className="specs-row">
                                                                        <div className="specs-label">Lực siết tối đa</div>
                                                                        <div className="specs-value">Cứng/Mềm: 30/14 N.m</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="product-reviews">
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-4">
                                                                <div className="overall-rating">
                                                                    ...
                                                                    <div className="rating-count">Based on 42 reviews</div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div className="rating-breakdown">
                                                                    <div className="rating-bar">
                                                                        ...
                                                                        <div className="progress">
                                                                            <div className="progress-bar" role="progressbar" style={{ width: '65%' }} aria-valuenow={65}
                                                                    ...
                                                                    <div className="rating-bar">
                                                                        ...
                                                                        <div className="progress">
                                                                            <div className="progress-bar" role="progressbar" style={{ width: '8%' }} aria-valuenow={8}
                                                                                aria-valuemin={0} aria-valuemax={100}></div>
                                                                        </div>
                                                                    ...
                                                                    <div className="rating-bar">
                                                                        ...
                                                                        <div className="progress">
                                                                            <div className="progress-bar" role="progressbar" style={{ width: '2%' }} aria-valuenow={2}
                                                                                aria-valuemin={0} aria-valuemax={100}></div>
                                                                        </div>
                                                    ...
                                                    <div className="reviews-list">
                                                        ...
                                                        <div className="review-item">
                                                            ...
                                                            <h5 className="review-title">Exceptional sound quality and comfort</h5>
                                                            <div className="review-content">
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue,
                                                                    ...
                                                                    venenatis. Suspendisse vulputate quam diam, et consectetur augue condimentum in.</p>
                                                            </div>
                                                        </div>{/* End Review Item */}
                                                        ...
                                                        <div className="review-item">
                                                            ...
                                                            <h5 className="review-title">Great headphones, battery could be better</h5>
                                                            <div className="review-content">
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue,
                                                                    suscipit elit nec, tincidunt orci. Phasellus egestas nisi vitae lectus imperdiet
                                                                    venenatis.</p>
                                                        ...
                                                        <div className="review-item">
                                                            ...
                                                            <h5 className="review-title">Impressive noise cancellation</h5>
                                                            <div className="review-content">
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue,
                                                                    suscipit elit nec, tincidunt orci. Phasellus egestas nisi vitae lectus imperdiet
                                                                    venenatis. Suspendisse vulputate quam diam.</p>
                                                            </div>
                                                        </div>{/* End Review Item */}
                                                    </div>
                                                        ...
                                                        <form className="review-form">
                                                            <div className="rating-select mb-4">
                                                                ...
                                                                <div className="star-rating">
                                                                    <input type="radio" id="star5" name="rating" value="5" /><label htmlFor="star5"
                                                                        title="5 stars"><i className="bi bi-star-fill"></i></label>
                                                                    <input type="radio" id="star4" name="rating" value="4" /><label htmlFor="star4"
                                                                        title="4 stars"><i className="bi bi-star-fill"></i></label>
                                                                    <input type="radio" id="star3" name="rating" value="3" /><label htmlFor="star3"
                                                                        title="3 stars"><i className="bi bi-star-fill"></i></label>
                                                                    <input type="radio" id="star2" name="rating" value="2" /><label htmlFor="star2"
                                                                        title="2 stars"><i className="bi bi-star-fill"></i></label>
                                                                    <input type="radio" id="star1" name="rating" value="1" /><label htmlFor="star1"
                                                                        title="1 star"><i className="bi bi-star-fill"></i></label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="mb-3">
                                                                ...
                                                                <input type="text" className="form-control" id="review-title" required />
                                                            </div>

                                                            <div className="mb-4">
                                                                <label htmlFor="review-content" className="form-label">Your Review</label>
                                                                <textarea className="form-control" id="review-content" rows={4} required></textarea>
                                                                <div className="form-text">Tell others what you think about this product. Be honest and helpful!
                                                                </div>
                                                            </div>

                                                            <div className="loading">Loading</div>
                                                            <div className="error-message"></div>
                                                            <div className="sent-message">Your review has been submitted. Thank you!</div>
